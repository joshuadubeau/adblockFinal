...
(function() {
    ...
    let sites = {
        'www.nytimes.com': { // website domain
            ...
            timeout: 1000, // in ms wait timeout before doing something
            interval: 5000, // in ms interval redo everything after this time (used if ads are added onscroll or timeout)
